...
const oneUserHTML = (user) => {
  ...
  content += `<span style='text-decoration: none;'><div class='col user-link'>`;
  ...
  content += `<div><br/><a class='btn btn-sm btn-outline-dark' href=${BASE}users/update/${user._id} role='button'>Edit Profile</a></div>`;
...
function getAllUsers() {
  ...
  fetch(`${BASE}users/updateProfile`, {
    method: "GET",
  })
